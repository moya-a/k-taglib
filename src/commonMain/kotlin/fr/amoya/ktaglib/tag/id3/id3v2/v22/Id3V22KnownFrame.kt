...
import fr.amoya.ktaglib.tag.id3.id3v2.contentFrames.Id3v2FrameContentParsers.rawParser
...
enum class Id3V22KnownFrame(
  override val description: String,
  override val parserFn: frameContentParserFn = ::rawParser
) : Id3V2KnownFrame
{
  NONE("Unknown Frame"),
