...
import fr.amoya.ktaglib.common.tags.id3.id3v2.frame.contentFrames.Id3FrameContentParsers.rawParser
...
enum class Id3v22KnownFrames(
  ...
  override val parser: (ByteArray) -> Id3FrameContent = ::rawParser
) : Id3v2KnownFrames
{
  NONE("Unknown Frame"),
