...
abstract class AbstractId3v2TagParser : TagParser
{
  ...
  companion object Constants
  {
    ...
    // text Encoding
    const val ISO_8859_1: Byte = 0x00
    const val UNICODE: Byte = 0x01
  ...
  {
    require(rawData.size >= 11) { "Frame Header + content must be at least 11 bytes" }
  ...
  {
    require(rawHeader.size >= headerSize) { "Id3 header size is 10 bytes" }
    return Id3Header()
      .apply {
